...
const Badge = ({ percentage }: { percentage: number }) => {
  ...
  const positiveClassname = `bg-green-900 text-green-400 ring-green-400/25`
    ...
    <div className="flex flex-col gap-6">
      <div className="grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6">
        <Card className="w-full mx-auto max-w-xs">
          ...
          <p className="text-3xl text-dark-tremor-content-subtle font-semibold">{avgVisitorsPerDay}</p>
        </Card>
        <Card className="w-full mx-auto max-w-xs">
          ...
          <p className="text-3xl text-dark-tremor-content-subtle font-semibold">{amtVisitorsToday}</p>
        </Card>
      </div>

      <Card className="flex flex-col sm:grid grid-cols-4 gap-6">
        <h2 className="w-full text-dark-tremor-content-subtle text-center sm:text-left font-semibold text-xl">
